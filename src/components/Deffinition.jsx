  ...
  return (
    <div>
      ...
      <div className="deffinition-text">
        <p>
          <b>Deffinition;</b> a practice or exercise to test or improve one's
          fitness for athletic competition, ability, or performance to exhaust
          (something, such as a mine) by working to devise, arrange, or achieve
