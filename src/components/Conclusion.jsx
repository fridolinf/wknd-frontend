  ...
  return (
    <div className='conclusion-body'>
      <div className="pov">
        ...
        <img className='img-help-and-tips' src={imgHelpAndTips} alt="path img help and tips" />
        ...
        {dataConclution.map((data) =>
          <div className='help-section' key={data.id}>
              <Col>
                <Card className='card-style' hoverable bordered={false} cover={<img src={data.image} alt={data.title} />} bodyStyle={{ display: 'none' }} />
              </Col>
              <Col className='card-footer'>
                <Col className='card-title' xs={{span: 40, offset: 1}} xl={{span: 30, offset: 1}}>
                  {data.title}
                </Col>
